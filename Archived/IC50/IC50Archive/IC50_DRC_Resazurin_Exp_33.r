...
## ---- Paths ------------------------------------------------------------------
raw_path      <- "IC50/Resazurin_Exp_33/20250713_Resazurin exp 33_BSO_BSOCSE_Rotenone_RotenoneCSE.txt"
compound_path <- "IC50/Resazurin_Exp_33/Resazurin_Exp_33_Compound.txt"
...
min_map <- c()           # U (0-dose) donor per compound
max_map <- c()           # L (top-dose) donor per compound
...
set.seed(cfg$seed)set.seed(cfg$seed)
...
# print(plot_compound(all_preds_ci, all_viability, "A2", colour_by = "PlateID"))
...
# write_csv(all_ic50, "Resazurin_Exp33_IC50_results.csv")